...
const showReadSpecies = (speciesArray, user) => {
  ...
  speciesArray.forEach((creature) => {
    document.querySelector('#cardContainer').innerHTML += `<div class="card mb-3" style="max-width: 540px;" id="speciesCard">
    <div class="row no-gutters">
      <div class="col-md-4">
        <img src="${creature.img}" class="card-img" alt="">
...
const noReadSpecies = () => {
  document.querySelector('#mainContainer').innerHTML = '<h1>I seek the white whale.</h1>';
};
